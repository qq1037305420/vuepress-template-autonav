...
module.exports = (options, ctx) => {
  return {
    async ready() {
      ...
      themeConfig.nav = themeConfig.nav.map(e => {
        e.link = e.link.split(String.fromCharCode(92)).join(String.fromCharCode(47))
        return e
      })
      var sidebars = {}
      for (var key in themeConfig.sidebar) {
        sidebars[key.split(String.fromCharCode(92)).join(String.fromCharCode(47))] = themeConfig.sidebar[key]
      }
      themeConfig.sidebar = sidebars
